...
**归档路径：** `tech-insights/daily-news/YYYY/MM/YYYY-MM-DD.md`（canonical，所有输出走 tech-insights/ repo 同步 GitHub + GitCode）
...
**归档路径：** `tech-insights/daily-news/YYYY/MM/YYYY-MM-DD-hf-trending.md`
...
**归档路径：** `tech-insights/daily-news/vc/YYYY-MM-DD.md`
